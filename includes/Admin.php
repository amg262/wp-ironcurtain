...
class Admin {
	...
	public function enqueue_admin_scripts() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			...
			wp_localize_script( $this->plugin_slug . '-admin-script', 'bom_object', [
	...
	public function add_plugin_admin_menu() {
		 ...
		 */
		$this->plugin_screen_hook_suffix = add_options_page( __( 'WP Reactivate', $this->plugin_slug ), __( 'WP Reactivate', $this->plugin_slug ), 'manage_options', $this->plugin_slug, [
				$this,
	...
	public function display_plugin_admin_page() {
		?>
        <div id="wp-bomsuite-admin"></div><?php
	}
