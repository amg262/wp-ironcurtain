...
class Example {
	...
	private function __construct() {
		$plugin            = IRC\Plugin::get_instance();
	...
	public function get_example( $request ) {
		$example_option = get_option( 'bom_example_setting' );
	...
	public function update_example( $request ) {
		$updated = update_option( 'bom_example_setting', $request->get_param( 'exampleSetting' ) );
	...
	public function delete_example( $request ) {
		$deleted = delete_option( 'bom_example_setting' );
