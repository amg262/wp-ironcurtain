 ...
 * @since 0.0.0
 */
function _manually_load_bom_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/bom.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_bom_plugin' );
