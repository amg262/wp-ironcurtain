...
class BOM_Settings {
	 ...
	 * @since  0.0.0
	 */
	protected static $key = 'bom_settings';
	 ...
	 * @since  0.0.0
	 */
	protected static $metabox_id = 'bom_settings_metabox';
	...
	public function __construct( $plugin ) {
		...
		// Set our title.
		$this->title = esc_attr__( 'BOM Settings', 'bom' );
	}
	...
	public function add_options_page_metabox() {
		...
		$cmb->add_field( array(
			'name'    => __( 'Test Text', 'bom' ),
			'desc'    => __( 'field description (optional)', 'bom' ),
			'id'      => 'test_text', // No prefix needed.
			'type'    => 'text',
			'default' => __( 'Default Text', 'bom' ),
		) );
